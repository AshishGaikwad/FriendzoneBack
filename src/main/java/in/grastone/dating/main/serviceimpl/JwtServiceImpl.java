...
public class JwtServiceImpl implements JwtService {
    ...
    @Override
    public String generateToken(String pMobile) {
        return generateToken(new HashMap<>(), pMobile);
    }
    ...
    private String generateToken(Map<String, Object> extraClaims, String pUserId) {
        return Jwts.builder().setClaims(extraClaims).setSubject(pUserId)
